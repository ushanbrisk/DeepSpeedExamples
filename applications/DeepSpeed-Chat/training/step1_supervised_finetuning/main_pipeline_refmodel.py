...
from pipelayers import (get_model,get_model_loss_fn, DataCollatorForPromptDataset,
...
def main():
    ...
    if args.custom_loss_fn:
        ...
        embed_tokens_ref_model = copy.deepcopy(model.lm_head)
        ...
        model_pipe = RefPipelineModule(layers=get_model_loss_fn(model),
                                    ...
                                    loss_fn = loss_fn_parent(model, embed_tokens_ref_model)
...
#config for reference model
    ...
    pipeline_sft_refmodel_config = {'pipeline_sft_refer_model':True,
                                    'engine': PipelineSFTRefModelEngine,
                                    }
