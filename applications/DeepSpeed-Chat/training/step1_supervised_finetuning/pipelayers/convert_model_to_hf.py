...
def set_args():
    ...
    parser.add_argument('--pipeline_model_dir', default='/ssd/output_test_202504091217_220k/global_step52', type=str, help='')
    parser.add_argument('--save_model_dir', default='/ssd/output_test_202504091217_220k', type=str, help='')
